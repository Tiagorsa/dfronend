  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('pages/relatorios/RelatorioContatosKanban')
      },
      {
        path: 'contatos-por-carteira',
        name: 'contatos-por-carteira',
        component: () => import('pages/relatorios/RelatorioContatosCarteira')
      },
      {
        path: 'atendimentos-por-parametros',
        name: 'atendimentos-por-parametros',
        component: () => import('pages/relatorios/RelatorioContatosAtendimento')
      }
    ]
  },
  {
