...
export default {
  ...
  methods: {
    ...
    setupThemes() {
      ...
      this.ticketsReasonsOptions = { ...this.ticketsReasonsOptions, theme };
      ...
      this.ticketsEvolutionByValueOptions = { ...this.ticketsEvolutionByValueOptions, theme };
      this.ticketsChannelsNamesOptions = [...this.ticketsChannelsNamesOptions, theme];
    },
    async listarFilas () {
    ...
    getDashTicketsReasons () {
      GetDashTicketsReasons(this.params).then(res => {
        ...
        const series = []
        const labels = []
        this.ticketsReasons.forEach(e => {
          series.push(+e.qtd)
          labels.push(e.name);
        })
        this.ticketsReasonsOptions.series = series
        this.ticketsReasonsOptions.labels = labels
        this.$refs.ChartTicketsReasons.updateOptions(this.ticketsReasonsOptions)
        this.$refs.ChartTicketsReasons.updateSeries(series, true)
      })
        .catch(err => {
          console.error(err)
        })
    ...
    getDashTicketsEvolutionChannelsName () {
      GetDashTicketsEvolutionChannelsName(this.params).then(res => {
        ...
        const series = []
        const labels = []
        this.ticketsChannelsNames.forEach(e => {
          series.push(+e.qtd)
          labels.push(e.label || this.$t('dashBoard.undefined'));  
        })
        this.ticketsChannelsNamesOptions.series = series
        this.ticketsChannelsNamesOptions.labels = labels
        this.$refs.ChartTicketsName.updateOptions(this.ticketsChannelsNamesOptions)
        this.$refs.ChartTicketsName.updateSeries(series, true)
      })
      .catch(err => {
        console.error(err)
      })
    ...
    getDashTicketsEvolutionByValue () {
      GetDashTicketsEvolutionByValue(this.params)
        .then(res => {
          ...
          this.$refs.ChartTicketsEvolutionByValue.updateOptions(this.ticketsEvolutionByValueOptions)
          this.$refs.ChartTicketsEvolutionByValue.updateSeries(series, true)
        })
        .catch(error => {
          console.error(error)
        })
