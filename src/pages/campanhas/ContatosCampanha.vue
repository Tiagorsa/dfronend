    ...
    >
      <q-card-section>
        <div class="row text-h6">
          {{ $t("contatosCampanha.campaign") }}: {{ $route.params.campanha.name }}
        </div>
        <div class="row text-caption">
          {{ $t("contatosCampanha.start") }}: {{ formatDate($route.params.campanha.start) }} - {{ $t("contatosCampanha.status") }}: {{ $route.params.campanha.status }}
        </div>
        <q-btn
