  ...
  <div v-if="userProfile === 'admin'">
    <q-list class="text-weight-medium">
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>{{ $t('configuracoesDialogflow.labels.enableDialogflow') }}</q-item-label>
          <q-item-label caption>{{ $t('configuracoesDialogflow.labels.enableDialogflowDescription') }}</q-item-label>
        </q-item-section>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>{{ $t('configuracoesDialogflow.labels.enableDialogflowAll') }}</q-item-label>
          <q-item-label caption>{{ $t('configuracoesDialogflow.labels.enableDialogflowAllDescription') }}</q-item-label>
        </q-item-section>
        <q-item-section avatar>
          <q-toggle
